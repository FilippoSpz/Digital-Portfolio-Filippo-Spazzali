...
const translations = {
  en: {
    ...
    'about.languagesText': 'Italian (Native), English (Proficient)',
    ...
    'experience.viaglut.desc1': 'Fixed, reinvented, and redesigned parts of the website using Magento, integrating HTML and CSS',
    'experience.viaglut.desc2': 'Designed user-friendly and intuitive web pages to enhance customer experience, working independently',
    'experience.circolo.desc1': 'Developed a management software from scratch using HTML, CSS, and JavaScript',
  ...
  it: {
    ...
    'about.languagesText': 'Italiano (Madrelingua), Inglese (Avanzato)',
    ...
    'experience.viaglut.desc1': 'Ho risolto problemi, reinventato e riprogettato parti del sito web utilizzando Magento, integrando HTML e CSS',
    'experience.viaglut.desc2': 'Ho progettato pagine web user-friendly e intuitive per migliorare l\'esperienza del cliente, lavorando in autonomia',
    'experience.circolo.desc1': 'Ho sviluppato da zero un software gestionale utilizzando HTML, CSS e JavaScript',
