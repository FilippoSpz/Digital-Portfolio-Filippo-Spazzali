...
const translations = {
  en: {
    ...
    'home.title': 'Software & Web Developer',
    'home.tagline': 'Software Developer with 4 years of experience specializing in web development. Skilled in HTML, CSS, JavaScript, TypeScript; known for driving user-centric digital transformation.',
    ...
    'experience.ceramiche.desc1': 'Developed and optimized user-friendly interfaces for Colori di Sicilia, tailored to showcase traditional Sicilian ceramics.',
    'experience.ceramiche.desc2': 'Created intuitive and user-oriented web pages to enhance browsing experience, managing the entire process independently.',
    'experience.artigiani.desc1': 'Built a full e-commerce platform for Artigiani della Pipa using Odoo, integrating custom HTML, CSS, and TypeScript.',
    'experience.artigiani.desc2': 'Delivered custom solutions to highlight handcrafted products with an elegant and intuitive user experience.',
    'experience.viaglut.desc1': 'Redesigned the Via Glut website, enhancing UI/UX and implementing responsive design to increase user engagement.',
    'experience.viaglut.desc2': 'Resolved technical issues and revamped site sections using Magento, HTML, and CSS, improving site performance.',
    ...
    'experience.wartsila.desc1': 'Designed and developed the initial user interface of a management program using HTML, CSS, and JavaScript, improving user accessibility.',
    'experience.wartsila.desc2': 'Collaborated in daily team meetings to gather feedback and enhance project outcomes.',
    ...
    'education.bachelors.desc1': 'Relevant Coursework: Computer Science Fundamentals, Algorithms and Data Structures, Digital Systems Architecture, Advanced Programming.',
    'education.bachelors.desc2': 'Logistics, Computer Networks, Operating Systems, Database Systems, Fundamentals of Automatic Control.',
  ...
  it: {
    ...
    'home.tagline': 'Sviluppatore Software con 4 anni di esperienza specializzato nello sviluppo web. Competente in HTML, CSS, JavaScript, TypeScript; noto per guidare la trasformazione digitale incentrata sull\'utente.',
    ...
    'experience.ceramiche.desc1': 'Ho sviluppato e ottimizzato interfacce user-friendly per Colori di Sicilia, pensate per mettere in mostra ceramiche siciliane tradizionali.',
    'experience.ceramiche.desc2': 'Ho creato pagine web intuitive e orientate all\'utente per migliorare l\'esperienza di navigazione, gestendo l\'intero processo in autonomia.',
    'experience.artigiani.desc1': 'Ho costruito una piattaforma e-commerce completa per Artigiani della Pipa utilizzando Odoo, integrando HTML, CSS e TypeScript personalizzati.',
    'experience.artigiani.desc2': 'Ho fornito soluzioni personalizzate per evidenziare prodotti artigianali con un\'esperienza utente elegante e intuitiva.',
    'experience.viaglut.desc1': 'Ho riprogettato il sito web Via Glut, migliorando UI/UX e implementando design responsive per aumentare l\'engagement degli utenti.',
    'experience.viaglut.desc2': 'Ho risolto problemi tecnici e rinnovato sezioni del sito utilizzando Magento, HTML e CSS, migliorando le prestazioni del sito.',
    ...
    'experience.wartsila.desc1': 'Ho progettato e sviluppato l\'interfaccia utente iniziale di un programma gestionale utilizzando HTML, CSS e JavaScript, migliorando l\'accessibilità.',
    'experience.wartsila.desc2': 'Ho collaborato nelle riunioni quotidiane del team per raccogliere feedback e migliorare i risultati del progetto.',
    ...
    'education.bachelors.desc1': 'Corsi rilevanti: Fondamenti di Informatica, Algoritmi e Strutture Dati, Architettura dei Sistemi Digitali, Programmazione Avanzata.',
    'education.bachelors.desc2': 'Logistica, Reti di Calcolatori, Sistemi Operativi, Sistemi di Basi di Dati, Fondamenti di Controllo Automatico.',
